...
let BuildingsRepository = class BuildingsRepository {
    ...
    deserialize(obj) {
        return (0, json_mapper_1.deserialize)(obj, { type: models_1.BuildingModel, collectionType: (0, core_1.isArray)(obj) ? Array : undefined });
    }
...
], BuildingsRepository.prototype, "prisma", void 0);
BuildingsRepository = __decorate([
    (0, di_1.Injectable)()
], BuildingsRepository);
